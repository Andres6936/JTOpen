...
class NPAttributeIFS
{
  private static final String copyright = "Copyright (C) 1997-2000 International Business Machines Corporation and others.";
    ...
    static
    {
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_BACK_OVERLAY) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_DATA_QUEUE) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_FORM_DEFINITION) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_FRONT_OVERLAY) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_MESSAGE_QUEUE) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_OUTPUT_QUEUE) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_PRINTER_FILE) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_WORKSTATION_CUST_OBJECT) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_USER_DEFINED_OBJECT) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_USER_TRANSFORM_PROG) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_USER_DRIVER_PROG) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_AFP_RESOURCE) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_PAGE_DEFINITION) - 1] =
        ...
        ifsAttrs[Math.abs(PrintObject.ATTR_SAVE_FILE) - 1] =
