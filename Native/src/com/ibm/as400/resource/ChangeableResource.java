...
{@link #getAttributeUnchangedValue(Object) getAttributeUnchangedValue(Object)}
or {@link #getAttributeUnchangedValue(Object, int) getAttributeUnchangedValue(Object, int)},
but <em>not</em> {@link #getAttributeValue(Object) getAttributeValue(Object)}
or {@link #getAttributeValue(Object, int) getAttributeValue(Object, int)}.
...
and {@link #getAttributeUnchangedValue(Object, int) getAttributeUnchangedValue(Object, int)}.
...
attribute values, you need to override either 
{@link #commitAttributeChanges(Object[], Object[]) commitAttributeChanges(Object[], Object[])}
or {@link #commitAttributeChanges(Object[], Object[], int[]) commitAttributeChanges(Object[], Object[], int[])},
but <em>not</em> {@link #commitAttributeChanges() commitAttributeChanges()},
{@link #setAttributeValue(Object, Object) setAttributeValue(Object, Object)}, or
{@link #setAttributeValue(Object, Object, int) setAttributeValue(Object, Object, int)}.

<p>If you do not plan to support bidirectional character conversion, then you only need 
to override {@link #commitAttributeChanges(Object[], Object[]) commitAttributeChanges(Object[], Object[])}.
If you do plan to support bidirectional character conversion, then you need
to override {@link #isBidiEnabled() isBidiEnabled()} to return true
and {@link #commitAttributeChanges(Object[], Object[], int[]) commitAttributeChanges(Object[], Object[], int[])}}.
...
changes need to be committed and calls {@link #commitAttributeChanges(Object[], Object[]) commitAttributeChanges(Object[], Object[])}.
