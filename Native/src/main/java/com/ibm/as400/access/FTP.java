...
// ---------------------------------------------------------------------------
    ...
    public synchronized boolean append(String sourceFileName, String targetFileName)
        ...
        boolean result = append(new File(sourceFileName), targetFileName);
...
// ---------------------------------------------------------------------------
    ...
    public synchronized boolean append(File sourceFileName, String targetFileName)
            throws IOException {
        if (Trace.isTraceOn())
...
// ---------------------------------------------------------------------------
     ...
     * @throws UnknownHostException  If a path to the system cannot be found.
     * @throws IOException           If an error occurs while connecting to the system.
     * @throws IllegalStateException If called before user and password are set.
     **/
...
// ---------------------------------------------------------------------------
     ...
     * Null is returned if the connection to the system fails.
     * @throws IOException           If an error occurs while communicating with the system.
     * @throws FileNotFoundException If the name is a directory or the name is not found.
     **/
...
// ---------------------------------------------------------------------------
     ...
     * @return true if the copy was successful; false otherwise.
     * @throws IOException           If an error occurs while communicating with the system.
     * @throws FileNotFoundException If the source file or the targe file
     *                               cannot be accessed.
     **/
    ...
    public synchronized boolean get(String sourceFileName, String targetFileName)
        ...
        boolean result = get(sourceFileName, new File(targetFileName));
...
// ---------------------------------------------------------------------------
    ...
    public synchronized boolean get(String sourceFileName, File targetFile)
            throws IOException, FileNotFoundException {
        if (Trace.isTraceOn())
...
// ---------------------------------------------------------------------------
     ...
     * @throws PropertyVetoException If the change is vetoed.
     * @throws IllegalStateException If connection already established to the system.
     **/
...
// ---------------------------------------------------------------------------
    ...
    public synchronized boolean put(String sourceFileName, String targetFileName)
        ...
        boolean result = put(new File(sourceFileName), targetFileName);
    ...
    public synchronized boolean put(File sourceFileName, String targetFileName)
            throws IOException {
        if (Trace.isTraceOn())
