...
public class BidiFlagSet {
     ...
     * @throws IllegalArgumentException If the arguments conflict or duplicate
     */
    public BidiFlagSet(BidiFlag flag1, BidiFlag flag2, BidiFlag flag3,
     ...
     * @throws IllegalArgumentException If the syntax of the data is invalid.
     * @see #toString
     */
    ...
    public BidiFlag getNumerals() {
        switch (this.value & NUMERALS_MASK) {
            case INUMERALS_NOMINAL:
                return BidiFlag.NUMERALS_NOMINAL;
            case INUMERALS_NATIONAL:
                return BidiFlag.NUMERALS_NATIONAL;
            case INUMERALS_CONTEXTUAL:
