...
public class AuthenticationServlet extends HttpServlet {
     ...
     * @throws ServletException A ServletException is thrown if a problem with the servlet occurs.
     */
     ...
     * @throws IOException An IOException is thrown if a communications error occurs.
     */
     ...
     * @throws SecurityException This exception should be thrown if validation fails.
     * @throws IOException       This exception should be thrown if a communication error occurs during validation.
     **/
