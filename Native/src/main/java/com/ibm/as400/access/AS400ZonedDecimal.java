...
public class AS400ZonedDecimal implements AS400DataType
{
    ...
    **/
    ...
    /**
     * Indicates if a {@link Double Double} object or a
     * {@link BigDecimal BigDecimal} object will be returned
    ...
    **/
    ...
    /**
     * Sets whether to return a {@link Double Double} object or a
     * {@link BigDecimal BigDecimal} object on a call to
     * {@link #toObject toObject()}.
     * @param b 
     * @see AS400PackedDecimal#setUseDouble
    **/
