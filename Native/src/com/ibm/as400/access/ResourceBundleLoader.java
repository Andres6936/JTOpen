...
class ResourceBundleLoader {
    ...
    /**
     * Set if there is an exception during the loading of the resource bundle
     */
    private static MissingResourceException resourceException_;

    /**
     * Core toolbox resources @B2A
     */
    private static ResourceBundle coreResources_;

    /**
     * Base toolbox resources needed in proxy jar file @B1C
     */
    private static ResourceBundle resources_;

    /**
     * Base toolbox resources NOT needed in proxy jar file @B1A
     */
    private static ResourceBundle resources2_;

    /**
     * Resource bundle for system value.
     */
     ...
     * @return The icon.
     **/
    static Icon getIcon(String fileName, String description) {
        Icon icon = null;
        ...
        try {
            ...
            if (url == null) {
                fileName = "com" + File.separator + "ibm" + File.separator +
                        "com/ibm/as400" + File.separator + "access" + File.separator +
                        fileName;
    ...
    static String getSystemValueText(String textId) {
        ...
        for (int i = 0; i < values.length; ++i) {
            ...
            if (j >= 0) {
                result = result.substring(0, j) +
                        values[i].toString() +
                        result.substring(j + variable.length());
            }
        }
        return result;
    }
