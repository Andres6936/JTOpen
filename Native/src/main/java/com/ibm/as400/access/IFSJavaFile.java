 ...
 **/
public class IFSJavaFile extends File implements java.io.Serializable {
...
// Because pathSeparator, pathSeparatorChar, separator and separatorChar are declared final in java.io.File, we cannot override them.
     ...
     * @throws SecurityException If an unanticipated security error occurs.
     **/
...
//  }
     ...
     * @throws IOException If an I/O error occurs while communicating with the IBM i system.
     **/
     ...
     * @throws SecurityException If the user is denied access to the file.
     **/
     ...
     * @throws SecurityException If the user is denied read access to the file.
     * @throws SecurityException If the user is denied access to the file.
     **/
