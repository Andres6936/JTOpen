   ...
   arrayOfZonedDecimalParm[@name] | packedDecimalParm[@name] | arrayOfPackedDecimalParm[@name]">
    ...
    <xsl:template name="finishParm">
        ...
        <xsl:if test="@passDirection">  <!-- passDirection attribute specified -->
            &lt;xs:attribute name="passDirection" type="passDirectionType" fixed="<xsl:value-of
                    select="@passDirection"/>" />
        </xsl:if>
        ...
        <xsl:if test="@fractionDigits">  <!-- count attribute specified -->
            &lt;xs:attribute name="fractionDigits" type="xs:nonNegativeInteger" fixed="<xsl:value-of
        ...
        <xsl:if test="@bidiStringType">  <!-- count attribute specified -->
            &lt;xs:attribute name="bidiStringType" type="bidiStringTypeType" fixed="<xsl:value-of
                    select="@bidiStringType"/>" />
        </xsl:if>
    ...
    <xsl:template name="setName">
        ...
        <xsl:choose>
            ...
            <xsl:when test="name()='arrayOfUnsignedIntParm'">
                &lt;xs:element name="<xsl:value-of select="$completeName"/>"
                substitutionGroup="unsignedIntParmArrayGroup" >
            </xsl:when>
            <xsl:when test="name()='hexBinaryParm'">
                &lt;xs:element name="<xsl:value-of select="$completeName"/>" substitutionGroup="hexBinaryParmGroup"
                default="" >
            </xsl:when>
            <xsl:when test="name()='arrayOfHexBinaryParm'">
            ...
            <xsl:when test="name()='arrayOfUnsignedShortParm'">
                &lt;xs:element name="<xsl:value-of select="$completeName"/>"
                substitutionGroup="unsignedShortParmArrayGroup" >
            </xsl:when>
            <xsl:when test="name()='longParm'">
            ...
            <xsl:when test="name()='arrayOfZonedDecimalParm'">
                &lt;xs:element name="<xsl:value-of select="$completeName"/>"
                substitutionGroup="zonedDecimalParmArrayGroup" >
            </xsl:when>
            <xsl:when test="name()='packedDecimalParm'">
            ...
            <xsl:when test="name()='arrayOfPackedDecimalParm'">
                &lt;xs:element name="<xsl:value-of select="$completeName"/>"
                substitutionGroup="packedDecimalParmArrayGroup" >
            </xsl:when>
        </xsl:choose>
    </xsl:template>
