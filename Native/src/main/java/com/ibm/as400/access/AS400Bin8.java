...
public class AS400Bin8 implements AS400DataType {
    ...
    /**
     * Returns {@link AS400DataType#TYPE_BIN8 TYPE_BIN8}.
     *
    ...
    public byte[] toBytes(Object javaValue) {
        ...
        BinaryConverter.longToByteArray((Long) javaValue, as400Value, 0);  // Allow this line to throw ClassCastException and NullPointerException
        return as400Value;
    }
    ...
    public int toBytes(Object javaValue, byte[] as400Value, int offset) {
        // BinaryConverter will throw the ArrayIndexException's
        BinaryConverter.longToByteArray((Long) javaValue, as400Value, offset);  // Allow this line to throw ClassCastException and NullPointerException
        return SIZE;
    }
