...
public class RowMetaDataType {
    ...
    {
        switch (type) {
            case RowMetaDataType.BIG_DECIMAL_DATA_TYPE:
                return true;
            case RowMetaDataType.DOUBLE_DATA_TYPE:
                return true;
            case RowMetaDataType.FLOAT_DATA_TYPE:
                return true;
            case RowMetaDataType.INTEGER_DATA_TYPE:
                return true;
            case RowMetaDataType.LONG_DATA_TYPE:
                return true;
            case RowMetaDataType.SHORT_DATA_TYPE:
                return true;
            default:
                return false;
        }
