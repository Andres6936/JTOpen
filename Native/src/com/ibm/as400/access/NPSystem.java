...
class NPSystem extends Object implements Runnable {
     ...
     * @throws AS400SecurityException          If security violation occurs during connection.
     * @throws ErrorCompletingRequestException If an error occurred on the server.
    ...
    public void run() {
        try {
            ...
            do {
                Thread.sleep(CONVERSATION_TIMEOUT);
