...
public class ObjectList implements Serializable {
     ...
     *                  Possible values are all object attributes contained in the {@link ObjectDescription ObjectDescription} class,
     *                  excluding the following:
     *                  <UL>
     *                  <LI>{@link ObjectDescription#LIBRARY ObjectDescription.LIBRARY}
     *                  <LI>{@link ObjectDescription#NAME ObjectDescription.NAME}
     *                  <LI>{@link ObjectDescription#TYPE ObjectDescription.TYPE}
     *                  </UL>
     ...
     *               include:
     *               <UL>
     *               <LI>{@link ObjectDescription#STATUS_NO_AUTHORITY ObjectDescription.STATUS_NO_AUTHORITY} - Objects that
     ...
     *               <LI>{@link ObjectDescription#STATUS_DAMAGED ObjectDescription.STATUS_DAMAGED} - Objects that are damaged.
     *               <LI>{@link ObjectDescription#STATUS_LOCKED ObjectDescription.STATUS_LOCKED} - Objects that are locked.
     *               <LI>{@link ObjectDescription#STATUS_PARTIALLY_DAMAGED ObjectDescription.STATUS_PARTIALLY_DAMAGED} - Objects
     ...
     * @throws ExtendedIllegalArgumentException if an invalid search type is specified.
     */
     ...
     *
     * @return An Enumeration of {@link ObjectDescription ObjectDescription} objects.
     * @throws AS400Exception                  If the system returns an error message.
     * @throws AS400SecurityException          If a security or authority error occurs.
     * @throws ConnectionDroppedException      If the connection is dropped unexpectedly.
     * @throws ErrorCompletingRequestException If an error occurs before the request is completed.
     * @throws InterruptedException            If this thread is interrupted.
     * @throws IOException                     If an error occurs while communicating with the system.
     * @throws ObjectDoesNotExistException     If the system object does not exist.
     ...
     * @return The array of retrieved {@link ObjectDescription ObjectDescription} objects.
