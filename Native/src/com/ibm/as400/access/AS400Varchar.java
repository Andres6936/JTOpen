...
public class AS400Varchar implements AS400DataType {
    ...
    /**
     * Returns {@link AS400DataType#TYPE_TEXT TYPE_TEXT}.
     *
    ...
    private void setTable() {
        if (tableImpl_ == null) {
            if (Trace.traceOn_)
                Trace.log(Trace.CONVERSION, "AS400Varchar object initializing, encoding: " + encoding_ + ", CCSID: " + ccsid_ + ", system: " + system_);
            if (encoding_ != null) {
                try {
            ...
            if (Trace.traceOn_)
                Trace.log(Trace.CONVERSION, "AS400Varchar object initialized, encoding: " + encoding_ + ", CCSID: " + ccsid_ + ", system: " + system_ + ", table: " + tableImpl_);
        }
    }
    ...
    public int toBytes(Object javaValue, byte[] serverValue, int offset, BidiConversionProperties properties) {
        ...
        if (Trace.traceOn_)
            Trace.log(Trace.CONVERSION, "AS400Varchar.toBytes(): Converted javaValue (" + toConvert + ") to:", serverValue, varOffset, length_);
