...
public class Subsystem {
     ...
     *
     * @param path The fully qualified pathname of the signon display file.  See {@link QSYSObjectPathName#toPath(String, String, String) QSYSObjectPathName.toString()}
     * @throws AS400Exception                  If the system returns an error message.
     * @throws AS400SecurityException          If a security or authority error occurs.
     * @throws ErrorCompletingRequestException If an error occurs before the request is completed.
     * @throws InterruptedException            If this thread is interrupted.
     ...
     * @throws IOException                     If an error occurs while communicating with the system.
     * @throws ObjectDoesNotExistException     If the object does not exist on the system.
     * @throws ObjectAlreadyExistsException    If the object already exists on the system.
     **/
    public void create()
     ...
     * @throws InterruptedException            If this thread is interrupted.
     * @throws IOException                     If an error occurs while communicating with the system.
     * @throws ObjectDoesNotExistException     If the system API (that queries subsystem description information) is missing.
     **/
    public boolean exists()
            throws AS400Exception, AS400SecurityException, ErrorCompletingRequestException, InterruptedException, IOException, ObjectDoesNotExistException {
        if (objectDescription_ == null) {
            objectDescription_ = getObjDesc();
        }
            ...
            for (int i = 0; i < numPools; i++) {
                ...
                if (DEBUG) {
                    ...
                    if (poolID < 1 || poolID > 10)
                        System.out.println("ERROR: Unexpected poolID value: " + poolID);  // This should never happen.
                }
