...
implements Serializable
{
  ...
  /**
   ...
   Valid values are:
   <ul>
   <li>{@link ISeriesNetServerFileShare#READ_ONLY ISeriesNetServerFileShare.READ_ONLY}
   <li>{@link ISeriesNetServerFileShare#READ_WRITE ISeriesNetServerFileShare.READ_WRITE}
   </ul>
   @exception  AS400SecurityException  If a security or authority error occurs.
   @exception  ErrorCompletingRequestException  If an error occurs before the request is completed.
   @exception  InterruptedException  If this thread is interrupted.
  ...
  /**
   ...
   The spooled file type is set to {@link ISeriesNetServerPrintShare#AUTO_DETECT ISeriesNetServerPrintShare.AUTO_DETECT}.
   @param shareName  The name of the share.
  ...
  /**
   ...
   Valid values are:
   <ul>
   <li>{@link ISeriesNetServerPrintShare#AFP ISeriesNetServerPrintShare.AFP}
   <li>{@link ISeriesNetServerPrintShare#AUTO_DETECT ISeriesNetServerPrintShare.AUTO_DETECT}
   <li>{@link ISeriesNetServerPrintShare#SCS ISeriesNetServerPrintShare.SCS}
   <li>{@link ISeriesNetServerPrintShare#USER_ASCII ISeriesNetServerPrintShare.USER_ASCII}
   </ul>
   @exception  AS400SecurityException  If a security or authority error occurs.
   @exception  ErrorCompletingRequestException  If an error occurs before the request is completed.
   @exception  InterruptedException  If this thread is interrupted.
