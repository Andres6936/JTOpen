...
public class SpooledFileOpenList extends OpenList {
    ...
    public void addSortField(int field, boolean ascending) {
        ...
        if (Trace.isTraceOn())
            Trace.log(Trace.DIAGNOSTIC, "Adding sort field, field: " + field + ", ascending: " + ascending);
    ...
    private final short findDataType(int field) {
        ...
        switch (field) {
            ...
            case NUMBER:
                return 0;
            case STATUS:
                return format_ == 3 ? (short) 0 : (short) 4;
            case DATE_OPENED:
                return 4;
            case TIME_OPENED:
                return 4;
    ...
    private final int findFieldLength(int field, int vrm) {
        switch (field) {
            ...
            case NUMBER:
                return 4;
            case STATUS:
                return format_ == 3 ? 4 : 10;
            case DATE_OPENED:
                return format_ != 1 || vrm >= 0x00050200 ? 7 : 0;
            case TIME_OPENED:
                return format_ != 1 || vrm >= 0x00050200 ? 6 : 0;
            case SCHEDULE:
                return format_ == 3 ? 1 : 0;
            case JOB_SYSTEM:
                return format_ == 3 ? 10 : vrm >= 0x00050200 ? 8 : 0;
            case USER_DATA:
                return 10;
            case FORM_TYPE:
                return 10;
            ...
            case COPIES_LEFT_TO_PRINT:
                return 4;
            case PRIORITY:
                return format_ == 3 ? 1 : 2;
            case PRINTER_NAME:
                return format_ == 2 ? 10 : 0;
            case PRINTER_ASSIGNED:
                return format_ == 2 ? 1 : 0;
            case CURRENT_PAGE:
                return format_ == 3 ? 0 : 4;
            case DEVICE_TYPE:
                return format_ == 3 ? 0 : 10;
            default:
                return 0;
        }
    }
    ...
    private final int findStartingPosition(int field) {
        ...
        switch (field) {
            case JOB_NAME:
                return format_ == 3 ? 1 : 11;
            case JOB_USER:
                return format_ == 3 ? 11 : 21;
            case JOB_NUMBER:
                return format_ == 3 ? 21 : 31;
            case NAME:
                return format_ == 3 ? 27 : 1;
            case NUMBER:
                return 37;
            case STATUS:
                return format_ == 3 ? 41 : 83;
            case DATE_OPENED:
                return format_ == 3 ? 45 : format_ == 2 ? 161 : 169;
            case TIME_OPENED:
                return format_ == 3 ? 52 : format_ == 2 ? 168 : 176;
            case SCHEDULE:
                return 58;
            case JOB_SYSTEM:
                return format_ == 3 ? 59 : format_ == 2 ? 193 : 161;
            case USER_DATA:
                return format_ == 3 ? 69 : 73;
            case FORM_TYPE:
                return format_ == 3 ? 79 : 93;
            case OUTPUT_QUEUE_NAME:
                return format_ == 3 ? 89 : 53;
            case OUTPUT_QUEUE_LIBRARY:
                return format_ == 3 ? 99 : 63;
            case ASP:
                return 109;
            case SIZE:
                return 113;
            case SIZE_MULTIPLIER:
                return 117;
            case TOTAL_PAGES:
                return format_ == 3 ? 121 : 41;
            case COPIES_LEFT_TO_PRINT:
                return format_ == 3 ? 125 : 49;
            case PRIORITY:
                return format_ == 3 ? 129 : 103;
            case PRINTER_NAME:
                return 175;
            case PRINTER_ASSIGNED:
                return 174;
