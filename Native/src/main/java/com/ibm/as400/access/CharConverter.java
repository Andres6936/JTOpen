...
public class CharConverter implements Serializable {
     ...
     * @throws UnsupportedEncodingException If the <i>encoding</i> is not supported.
     */
     ...
     * @throws UnsupportedEncodingException If the <i>ccsid</i> is not supported.
     */
     ...
     * @throws UnsupportedEncodingException If the specified CCSID is not supported.
     ...
     * @throws CharConversionException If <i>destination</i> is not large enough to hold the converted string.
     **/
