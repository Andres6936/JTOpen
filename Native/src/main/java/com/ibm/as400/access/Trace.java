  ...
  */
    ...
    static void loadTraceProperties() {
        ...
        if (categories0 != null) {
            ...
            if (Trace.traceOn_)
                Trace.log(Trace.WARNING, "Incorrect tracing property name specified: " + SystemProperties.TRACE_CATEGORIES);
        }
    ...
    private static final void logData(Object component,
        ...
        }  // tracing is not activated for the specified category, so do nothing
    }
