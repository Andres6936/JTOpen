...
public class Main implements Runnable {
        ...
        try {
            ...
            if (upcaseCommand.startsWith("PREPARE")) {
                ...
                try {
                    ...
                    Method method = traceClass.getMethod("setDb2Trace",
                            argClasses);
                    Object[] args = new Object[1];
                    if (setting.startsWith("true")) {
                ...
                try {
                    ...
                    Method method = utilClass.getMethod("registerApp",
                            argClasses);
                    ...
                    Method mainMethod = debugClass.getMethod("main",
                            mainArgsClasses);
                                        ...
                                        if (p == methodParameterCount) {
                                            if ((argsLeft.trim().equals(")"))
                                                ...
                                                try {
                                                    ...
                                                    if (printStackTrace_)
                                                        printStackTraceToStringBuffer(e, possibleErrors);
    ...
    void handleFileBlobParm(PreparedStatement cstmt, String thisParm, int parm,
        ...
        Blob blob = (Blob) getParameterObject(thisParm, out);
    ...
    void handleFileClobParm(PreparedStatement cstmt, String thisParm, int parm,
                            PrintStream out) throws SQLException {
        Clob clob = (Clob) getParameterObject(thisParm, out);
    ...
    void addVariable(String var, Object value) {
        ...
        if (var.equals("CON")) {
            ...
            stmt_ = (Statement) value;
        } else if (var.equals("PSTMT")) {
            pstmt_ = (PreparedStatement) value;
        } else if (var.equals("CSTMT")) {
            cstmt_ = (CallableStatement) value;
        } else if (var.equals("RS")) {
            manualResultSet_ = (ResultSet) value;
        }
    }
