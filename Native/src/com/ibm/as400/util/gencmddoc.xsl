...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  &#x3c;</xsl:text><xsl:text>&#x21;</xsl:text>doctype html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"<xsl:text
        ...
        <html>
            ...
            <head>
                <xsl:text>&#xa;</xsl:text>
                <title>
                    <xsl:value-of select="Cmd/@Prompt"/><xsl:text>  </xsl:text>(<xsl:value-of select="Cmd/@CmdName"/>)
                </title>
                <xsl:text>&#xa;</xsl:text>
            </head>
            <xsl:text>&#xa;</xsl:text>
            <body bgcolor="white">
                <xsl:text>&#xa;</xsl:text>
                <a>
                    <xsl:attribute name="name"><xsl:value-of select="$CommandName"/>.Top_Of_Page
                    </xsl:attribute>
                </a>
                <xsl:text>&#xa;</xsl:text>
    ...
    <xsl:template match="Cmd">
        <h2>
            <xsl:value-of select="@Prompt"/><xsl:text>  </xsl:text>(<xsl:value-of select="@CmdName"/>)
        </h2>
            ...
            <tr>
                ...
                <td align="left" valign="top">
                    ...
                    <xsl:if test="substring($WhereAllowed,1,9)!='000000000'">
                        <b><xsl:value-of select="$_WHERE_ALLOWED_TO_RUN"/>:<xsl:text>  </xsl:text>
                        </b>
                        <xsl:text/>
                        <xsl:choose>

                            <xsl:when test="substring($WhereAllowed,1,9)='111111111'">
                                <xsl:value-of select="$_ALLOW_ALL"/>
                                <br/>
                                <xsl:text>&#xa;</xsl:text>
                            </xsl:when>

                            <xsl:when test="substring($WhereAllowed,1,9)='011100101'">
                                <xsl:value-of select="$_ALLOW_INTERACTIVE1"/>
                                <br/>
                                <xsl:text>&#xa;</xsl:text>
                            </xsl:when>

                            <xsl:when test="substring($WhereAllowed,1,9)='011100100'">
                                <xsl:value-of select="$_ALLOW_INTERACTIVE2"/>
                                <br/>
                                <xsl:text>&#xa;</xsl:text>
                            </xsl:when>

                            <xsl:when test="substring($WhereAllowed,1,9)='110001111'">
                                <xsl:value-of select="$_ALLOW_COMPILED_CL_OR_REXX1"/>
                                <br/>
                                <xsl:text>&#xa;</xsl:text>
                            </xsl:when>

                            <xsl:when test="substring($WhereAllowed,1,9)='110001100'">
                                <xsl:value-of select="$_ALLOW_COMPILED_CL_OR_REXX2"/>
                                <br/>
                                <xsl:text>&#xa;</xsl:text>
                            </xsl:when>
                            ...
                            <xsl:otherwise>
                                ...
                                <ul>
                                    ...
                                    <xsl:if test="substring($WhereAllowed,5,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_JOB_BATCH"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="substring($WhereAllowed,4,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_JOB_INTERACTIVE"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="substring($WhereAllowed,1,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_PROGRAM_BATCH"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="substring($WhereAllowed,2,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_PROGRAM_INTERACTIVE"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="substring($WhereAllowed,8,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_MODULE_BATCH"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="substring($WhereAllowed,9,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_MODULE_INTERACTIVE"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="substring($WhereAllowed,6,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_REXX_BATCH"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="substring($WhereAllowed,7,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_REXX_INTERACTIVE"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                                    <xsl:if test="substring($WhereAllowed,3,1)='1'">
                                        <li>
                                            <xsl:value-of select="$_ALLOW_USING_COMMAND_API"/>
                                        </li>
                                        <xsl:text>&#xa;</xsl:text>
                                    </xsl:if>
                        ...
                        <b><xsl:value-of select="$_THREADSAFE"/>:<xsl:text>  </xsl:text>
                        </b>
                        <xsl:text/>
                        <xsl:choose>
                ...
                <td align="right" valign="top">
                    <xsl:text>&#xa;</xsl:text>
                    <a>
                        <xsl:attribute name="href">#<xsl:value-of select="@CmdName"/>.PARAMETERS.TABLE
                        </xsl:attribute>
                    ...
                    <xsl:choose>
                        <xsl:when test="$HasExamplesOld or $HasExamplesNew">
                            <a>
                                <xsl:attribute name="href">#<xsl:value-of select="$CommandHelpID"/>.COMMAND.EXAMPLES
                                </xsl:attribute>
                                <xsl:value-of select="$_EXAMPLES"/>
                            </a>
                        </xsl:when>
                        <xsl:otherwise>
                            <a>
                                <xsl:attribute name="href">#<xsl:value-of select="@CmdName"/>.COMMAND.EXAMPLES
                                </xsl:attribute>
                                <xsl:value-of select="$_EXAMPLES"/>
                            </a>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="$HasErrorMessagesOld or $HasErrorMessagesNew">
                            <a>
                                <xsl:attribute name="href">#<xsl:value-of select="$CommandHelpID"/>.ERROR.MESSAGES
                                </xsl:attribute>
                                <xsl:value-of select="$_ERRORS"/>
                            </a>
                        </xsl:when>
                        <xsl:otherwise>
                            <a>
                                <xsl:attribute name="href">#<xsl:value-of select="@CmdName"/>.ERROR.MESSAGES
                                </xsl:attribute>
                                <xsl:value-of select="$_ERRORS"/>
                            </a>
                        </xsl:otherwise>
            ...
            <h3>
                <a>
                    <xsl:attribute name="name">
                        <xsl:value-of select="@CmdName"/>.PARAMETERS.TABLE
                    </xsl:attribute>
                    <xsl:value-of select="$_PARAMETERS"/>
                </a>
            </h3>
            ...
            <xsl:otherwise>
                <div>
                    ...
                    <h3>
                        <a>
                            <xsl:attribute name="name">
                                <xsl:value-of select="$CommandName"/>.COMMAND.EXAMPLES
                            </xsl:attribute>
                            <xsl:value-of select="$_EXAMPLES"/>
                        </a>
                    </h3>
            ...
            <xsl:otherwise>
                <div>
                    ...
                    <h3>
                        <a>
                            <xsl:attribute name="name">
                                <xsl:value-of select="$CommandName"/>.ERROR.MESSAGES
                            </xsl:attribute>
                            <xsl:value-of select="$_ERRORS"/>
                        </a>
                    </h3>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <xsl:choose>
                    <xsl:when test="$CommandHelp!='__NO_HELP'">
                        <a>
                            <xsl:attribute name="href">#<xsl:value-of select="$CommandHelpID"/>.<xsl:value-of
                                    select="@Kwd"/>
                            </xsl:attribute>
                            <b>
            ...
            <td valign="top">
                ...
                <xsl:if test="number(../@MaxPos) >= number($ParmPos)">
                    <xsl:text/>,
                    <xsl:value-of select="$_POSITIONAL"/><xsl:text> </xsl:text><xsl:value-of select="number($ParmPos)"/>
                </xsl:if>
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <xsl:if test="$NumIndent!=0">
                    <xsl:attribute name="style">padding-left:<xsl:value-of select="$NumIndent"/>pt
                    </xsl:attribute>
                </xsl:if>

                <xsl:value-of select="$_ELEMENT"/><xsl:text> </xsl:text>
                <xsl:number count="Elem"/>:<xsl:text> </xsl:text><xsl:value-of select="@Prompt"/>
            </td>
            <xsl:text>&#xa;</xsl:text>
    ...
    <xsl:template match="Qual">
        <tr>
            ...
            <td valign="top">
                ...
                <xsl:value-of select="$_QUALIFIER"/><xsl:text> </xsl:text>
                <xsl:number count="Qual"/>:<xsl:text> </xsl:text><xsl:text/>
                <xsl:choose>
    ...
    <xsl:template name="AddLinkToTop">
        ...
        <table width="100%">
            ...
            <tr>
                <td align="right">
                    <a>
                        <xsl:attribute name="href">#<xsl:value-of select="$CommandName"/>.Top_Of_Page
                        </xsl:attribute>
                        <xsl:value-of select="$_TOP_OF_PAGE"/>
                    </a>
                </td>
            </tr>
            <xsl:text>&#xa;</xsl:text>
    ...
    <xsl:template name="GenType">
        <xsl:choose>
            <xsl:when test="@Type='SNAME'">
                <i>
                    <xsl:value-of select="$_TYPE_SIMPLE_NAME"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='PNAME'">
                <i>
                    <xsl:value-of select="$_TYPE_PATH_NAME"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='NAME'">
                <i>
                    <xsl:value-of select="$_TYPE_NAME"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='CNAME'">
                <i>
                    <xsl:value-of select="$_TYPE_COMMUNICATIONS_NAME"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='GENERIC'">
                <i><xsl:value-of select="$_TYPE_GENERIC_NAME"/>,<xsl:text> </xsl:text><xsl:value-of
                        select="$_NAME_LOWERCASE"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='INT2'">
                <i>
                    <xsl:value-of select="$_TYPE_INTEGER"/>
                </i>
                <xsl:text/>
            </xsl:when>
            ...
            <xsl:when test="@Type='UINT2'">
                <i>
                    <xsl:value-of select="$_TYPE_UNSIGNED_INTEGER"/>
                </i>
                <xsl:text/>
            </xsl:when>
            ...
            <xsl:when test="@Type='DEC'">
                <i>
                    <xsl:value-of select="$_TYPE_DECIMAL_NUMBER"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='CMD'">
                <i>
                    <xsl:value-of select="$_TYPE_COMMAND_STRING"/>
                </i>
                <xsl:text/>
            </xsl:when>
            ...
            <xsl:when test="@Type='LGL'">
                <i>
                    <xsl:value-of select="$_TYPE_VALUE_LOGICAL"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='CHAR'">
                <i>
                    <xsl:value-of select="$_TYPE_VALUE_CHARACTER"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='VARNAME'">
                <i>
                    <xsl:value-of select="$_TYPE_CL_VARIABLE_NAME"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='DATE'">
                <i>
                    <xsl:value-of select="$_TYPE_DATE"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='TIME'">
                <i>
                    <xsl:value-of select="$_TYPE_TIME"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='HEX'">
                <i>
                    <xsl:value-of select="$_TYPE_VALUE_HEX"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='X'">
                <i>
                    <xsl:value-of select="$_TYPE_NOT_RESTRICTED"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='ELEM'">
                <i>
                    <xsl:value-of select="$_TYPE_ELEMENT_LIST"/>
                </i>
                <xsl:text/>
            </xsl:when>
            <xsl:when test="@Type='QUAL'">
                <xsl:choose>
                    <xsl:when test="count(child::Qual)=2">
                        <i>
                            <xsl:value-of select="$_TYPE_QUALIFIED_OBJECT_NAME"/>
                        </i>
                        <xsl:text/>
                    </xsl:when>
                    <xsl:when test="count(child::Qual)=3">
                        <i>
                            <xsl:value-of select="$_TYPE_QUALIFIED_JOB_NAME"/>
                        </i>
                        <xsl:text/>
                    </xsl:when>
                    <xsl:otherwise>
                        <i>
                            <xsl:value-of select="$_TYPE_QUALIFIER_LIST"/>
                        </i>
                        <xsl:text/>
                    </xsl:otherwise>
                </xsl:choose>
