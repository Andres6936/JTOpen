...
class SystemResourceFinder {
    ...
    private static final InputStream loadResource(String docPath) {
        ...
        if (loader != null) {
            ...
            if (stream != null) {
                if (Trace.isTraceOn()) {
                    Trace.log(Trace.PCML, "SystemResourceFinder.loadResource found " + docPath);
                }
    ...
    private static final ClassLoader getLoader1() {
        ...
        try {
            ...
            if (Trace.isTraceOn())
                Trace.log(Trace.PCML, "Couldn't get current thread's context class loader: " + t.toString());
            return null;
        }
    }
    ...
    private static final ClassLoader getLoader2() {
        try {
            ...
            try {
                ...
                if (Trace.isTraceOn())
                    Trace.log(Trace.PCML, "Couldn't get SystemResourceFinder class loader: " + t2.toString());
                return null;
            }
        } catch (Throwable t) {
    ...
    protected static boolean isXPCML(String docName, ClassLoader loader)
        ...
        try {
            ...
            if (lnr != null) try {
                lnr.close();
            } catch (Exception e) { /* Ignore exception on close */ }
