...
//@A5D extends AS400JDBCConnection
{
     ...
     * @throws SQLException If the connection is not open, the maximum number
     ...
     * @throws SQLException - Always thrown because the Toolbox JDBC driver does does not support this method.
     * @since Modification 5
     **/
