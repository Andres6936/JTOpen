...
public abstract class ConvTable {
    ...
    public static final ConvTable getTable(String encoding) throws UnsupportedEncodingException {
        ...
        try {
            ...
            if (newTable != null) {
                if (Trace.traceOn_)
                    Trace.log(Trace.CONVERSION, "Reusing previously loaded Java conversion table for encoding: " + encoding);
                return newTable;
            }
    ...
    public static final ConvTable getTable(int ccsid, AS400ImplRemote system) throws UnsupportedEncodingException {
        ...
        try {
            ...
            if (className == null) {
                if (Trace.traceOn_)
                    Trace.log(Trace.CONVERSION, "Could not find an encoding that matches ccsid: " + ccsid);
            ...
            if (newTable != null) {
                if (Trace.traceOn_)
                    Trace.log(Trace.CONVERSION, "Reusing previously loaded Java conversion table for ccsid: " + ccsid);
