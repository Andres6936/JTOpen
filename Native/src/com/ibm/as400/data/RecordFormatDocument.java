...
public class RecordFormatDocument implements Serializable, Cloneable {
     ...
     * or {@link #setValues(String, Record) setValues} must be called.
     */
     ...
     * @throws XmlException when the specified RFML document cannot be found.
     */
     ...
     * <ul>
     * <li>{@link AS400Structure AS400Structure}
     * <li>{@link AS400Array AS400Array} with elements of type AS400Array (multidimensional array)
     * </ul>
     *
...
//      if (dataType instanceof AS400Structure) {
            ...
            case AS400DataType.TYPE_TEXT:
                ...
                try {
                    if (fieldDesc instanceof ArrayFieldDescription) {
                        ...
                        Method method = fieldDesc.getClass().getMethod("getCCSID", (Class[]) null); //@pdc cast for jdk1.5
                        String ccsids = (String) method.invoke(fieldDesc, (Object[]) null); //@pdc cast for jdk1.5
    ...
    private static RfmlDocument loadSerializedRfmlDocument(String docName, ClassLoader loader)
        ...
        try {
            ...
            if (in != null) try {
                in.close();
            } catch (Exception e) { /* Ignore any exception on close. */ }
     ...
     * @throws XmlException If an error occurs while processing RFML, or if an encoding specified by the Record is unsupported.
     **/
