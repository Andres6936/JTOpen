...
class PcmlDataValues extends Object implements Serializable         // @C1C
{
        ...
        switch (dataType) {
            ...
            case PcmlData.INT:
                if (dataLength == 2) {
                    ...
                    } else { // dataPrecision == 15 or defaulted
                        if (newVal instanceof String) {
                ...
                } else if (dataLength == 4)                                // @C3A
                {
                    ...
                    } else { // dataPrecision == 31 or defaulted
                        if (newVal instanceof String) {
                            convertedVal = new Integer((String) newVal);
                        } else {
                            if (newVal instanceof Integer) {
                ...
                { // dataLength == 8                                // @C3A
                    ...
                    } else { // dataPrecision == 63 or defaulted
    ...
    static String trimString(String str, String trimEnd) {
        ...
        if (trimEnd != null && (trimEnd.equals("left") || trimEnd.equals("both"))) {
            // Trim blanks and nulls
            trimLeft:
            while (startOffset < lengthReturned) {
    ...
    private Class getValueClass() throws PcmlException {
        ...
        //try   //@O6D
        {
            switch (dataType) {
                ...
                case PcmlData.CHAR:
                    return String.class;// @O6C Class.forName("java.lang.String");

                case PcmlData.INT:
                    if (dataLength == 2) {
                        if (dataPrecision == 16) {
                            return Integer.class; //@O6C Class.forName("java.lang.Integer");
                        } else { // dataPrecision == 15 or defaulted
                            return Short.class; //@O6C Class.forName("java.lang.Short");
                        }
                    } else if (dataLength == 4)                            // @C3A
                    { // dataLength == 4
                        if (dataPrecision == 32) {
                            return Long.class;//@O6C Class.forName("java.lang.Long");
                        } else { // dataPrecision == 31 or defaulted
                            return Integer.class;//@O6C Class.forName("java.lang.Integer");
                        }
                    } else                                            // @C3A
                        ...
                        { // dataLength == 8                            // @C3A
                            if (dataPrecision == 64) {
                                return BigInteger.class;//@O6C Class.forName("java.math.BigInteger");
                            } else { // dataPrecision == 63 or defaulted
                                return Long.class;//@O6C Class.forName("java.lang.Long");  // @C3A
                            }
                        }                                               // @C3A

                case PcmlData.PACKED:
                case PcmlData.ZONED:
                    return BigDecimal.class;//@O6C Class.forName("java.math.BigDecimal");


                case PcmlData.FLOAT:
                    if (dataLength == 4) {
                        return Float.class;//@O6C Class.forName("java.lang.Float");
                    } else { // Must be length=8
                        return Double.class;//@O6C Class.forName("java.lang.Double");
                    }
