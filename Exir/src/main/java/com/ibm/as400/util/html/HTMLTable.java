...
public class HTMLTable extends HTMLTagAttributes implements HTMLConstants, Serializable {
    ...
    public void setBorderWidth(int borderWidth) throws PropertyVetoException {
        ...
        if (vetos_ != null)
            vetos_.fireVetoableChange("borderWidth", new Integer(oldWidth), new Integer(borderWidth)); //@CRS

        borderWidth_ = borderWidth;

        if (changes_ != null)
            changes_.firePropertyChange("borderWidth", new Integer(oldWidth), new Integer(borderWidth)); //@CRS
    }
    ...
    public void setCellPadding(int cellPadding) throws PropertyVetoException {
        ...
        if (vetos_ != null)
            vetos_.fireVetoableChange("cellPadding", new Integer(oldPadding), new Integer(cellPadding)); //@CRS

        cellPadding_ = cellPadding;

        if (changes_ != null)
            changes_.firePropertyChange("cellPadding", new Integer(oldPadding), new Integer(cellPadding)); //@CRS
    }
    ...
    public void setCellSpacing(int cellSpacing) throws PropertyVetoException {
        ...
        if (vetos_ != null)
            vetos_.fireVetoableChange("cellSpacing", new Integer(oldSpacing), new Integer(cellSpacing)); //@CRS

        cellSpacing_ = cellSpacing;

        if (changes_ != null)
            changes_.firePropertyChange("cellSpacing", new Integer(oldSpacing), new Integer(cellSpacing)); //@CRS
    }
    ...
    public void setHeaderInUse(boolean headerInUse) throws PropertyVetoException {
        ...
        if (vetos_ != null)
            vetos_.fireVetoableChange("useHeader", new Boolean(oldUse), new Boolean(headerInUse)); //@CRS

        headerInUse_ = headerInUse;

        if (changes_ != null)
            changes_.firePropertyChange("useHeader", new Boolean(oldUse), new Boolean(headerInUse)); //@CRS
    }
    ...
    public void setWidthInPercent(boolean widthInPercent) throws PropertyVetoException {
        ...
        if (vetos_ != null)
            vetos_.fireVetoableChange("widthInPercent", new Boolean(oldValue), new Boolean(widthInPercent)); //@CRS

        widthPercent_ = widthInPercent;

        if (changes_ != null)
            changes_.firePropertyChange("widthInPercent", new Boolean(oldValue), new Boolean(widthInPercent)); //@CRS
    }
