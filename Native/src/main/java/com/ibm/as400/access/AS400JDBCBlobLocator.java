...
public class AS400JDBCBlobLocator implements Blob {
     ...
     * array of length 0.
     * @throws SQLException If the position is not valid or an error occurs.
     **/
     ...
     * @throws SQLException If there is an error accessing the BLOB or if the position
     ...
     *                     truncation.
     * @throws SQLException If there is an error accessing the BLOB or if the length
     *                      specified is greater than the length of the BLOB.
     **/
