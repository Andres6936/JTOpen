        ...
        implements DataSource, Referenceable, Serializable, Cloneable //@PDC 550
{
    ...
    public Reference getReference() throws NamingException {
        ...
        if (sockProps_.loginTimeoutSet_)
            ref.add(new StringRefAddr(SOCKET_LOGIN_TIMEOUT, Integer.toString(sockProps_.loginTimeout_))); //@st3
    ...
    public void setServerName(String serverName) {
        ...
        } catch (PropertyVetoException pv) { /* ignore */
        }
    ...
    public void setUser(String user) {
        ...
        } catch (PropertyVetoException vp) { /* ignore */
        }
