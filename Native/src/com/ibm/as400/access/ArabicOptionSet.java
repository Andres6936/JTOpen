...
//--------
     ...
     * @throws IllegalArgumentException If the arguments conflict or are duplicates.
     */
    public ArabicOptionSet(ArabicOption option1, ArabicOption option2) {
        this.value = option1.value();
        if ((this.value & option2.value()) != 0)
    ...
    public ArabicOption getLamAlefMode() {
        return switch (this.value & LAMALEF_MASK) {
            case ILAMALEF_RESIZE_BUFFER -> ArabicOption.LAMALEF_RESIZE_BUFFER;
            case ILAMALEF_NEAR -> ArabicOption.LAMALEF_NEAR;
            case ILAMALEF_ATBEGIN -> ArabicOption.LAMALEF_ATBEGIN;
            case ILAMALEF_ATEND -> ArabicOption.LAMALEF_ATEND;
            case ILAMALEF_AUTO -> ArabicOption.LAMALEF_AUTO;
            default -> ArabicOption.LAMALEF_ATBEGIN;
        };
    }
    ...
    public ArabicOption getSeenMode() {
        return switch (this.value & SEEN_MASK) {
            case ISEEN_NEAR -> ArabicOption.SEEN_NEAR;
            case ISEEN_ATBEGIN -> ArabicOption.SEEN_ATBEGIN;
            case ISEEN_ATEND -> ArabicOption.SEEN_ATEND;
            case ISEEN_AUTO -> ArabicOption.SEEN_AUTO;
            default -> ArabicOption.SEEN_NEAR;
        };
    }
    ...
    public ArabicOption getYehHamzaMode() {
        return switch (this.value & YEHHAMZA_MASK) {
            case IYEHHAMZA_TWO_CELL_NEAR -> ArabicOption.YEHHAMZA_TWO_CELL_NEAR;
            case IYEHHAMZA_TWO_CELL_ATBEGIN -> ArabicOption.YEHHAMZA_TWO_CELL_ATBEGIN;
            case IYEHHAMZA_TWO_CELL_ATEND -> ArabicOption.YEHHAMZA_TWO_CELL_ATEND;
            case IYEHHAMZA_ONE_CELL -> ArabicOption.YEHHAMZA_ONE_CELL;
            case IYEHHAMZA_AUTO -> ArabicOption.YEHHAMZA_AUTO;
            default -> ArabicOption.YEHHAMZA_TWO_CELL_NEAR;
        };
    }
    ...
    public ArabicOption getTashkeelMode() {
        return switch (this.value & TASHKEEL_MASK) {
            case ITASHKEEL_KEEP -> ArabicOption.TASHKEEL_KEEP;
            case ITASHKEEL_CUSTOMIZED_WITHZEROWIDTH -> ArabicOption.TASHKEEL_CUSTOMIZED_WITHZEROWIDTH;
            case ITASHKEEL_CUSTOMIZED_WITHWIDTH -> ArabicOption.TASHKEEL_CUSTOMIZED_WITHWIDTH;
            case ITASHKEEL_CUSTOMIZED_ATBEGIN -> ArabicOption.TASHKEEL_CUSTOMIZED_ATBEGIN;
            case ITASHKEEL_CUSTOMIZED_ATEND -> ArabicOption.TASHKEEL_CUSTOMIZED_ATEND;
            case ITASHKEEL_AUTO -> ArabicOption.TASHKEEL_AUTO;
            default -> ArabicOption.TASHKEEL_KEEP;
        };
    }
