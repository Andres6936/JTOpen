...
abstract public class AS400File implements Serializable {
     ...
     * @see AS400File#AS400File(com.ibm.as400.access.AS400, String)
     ...
     *
     * @throws Throwable If an exception is thrown while cleaning up.
     **/
    ...
    public void setPath(String name)
        ...
        // Verify object state
        if (isOpen_) { // Cannot set after we have connected
     ...
     * @see AS400File#create(RecordFormat, String)
    ...
    synchronized void openFile(int openType,
        ...
        } else { // For open type of READ_WRITE or if the file is a KeyedFile, blocking
    ...
    private void setName(String name) {
        ...
        if (!(ifs.getObjectType().equals("FILE") || ifs.getObjectType().equals("MBR"))) { // Invalid object type
        ...
        if (ifs.getObjectType().equals("FILE")) { // No member specified; default member to *FIRST
            member_ = "*FIRST";
        } else { // Member specified; if special value %FILE% was specified, member name
            // is the file name
