...
public class SystemStatus implements Serializable {
     ...
     * elapsed time.
     * @throws AS400SecurityException          If a security or authority error occurs.
     * @throws ErrorCompletingRequestException If an error occurs before the request is
     *                                         completed.
     * @throws InterruptedException            If this thread is interrupted.
     * @throws IOException                     If an error occurs while communicating with the system.
     * @throws ObjectDoesNotExistException     If the object does not exist on the system.
    ...
    private void loadInformation(int format, boolean reset) throws AS400SecurityException, ErrorCompletingRequestException, InterruptedException, IOException, ObjectDoesNotExistException {
        ...
        do {
            ...
            if (bytesReturned < bytesAvailable) {
                repeatRun = true;
                if (Trace.traceOn_)
                    Trace.log(Trace.DIAGNOSTIC, "Retrieve system status receiver variable too small, bytes returned: " + bytesReturned + ", bytes available: " + bytesAvailable);
