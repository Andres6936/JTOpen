...
public class AS400JDBCClob implements Clob, Serializable {
     ...
     * @return The contents.
     * @throws SQLException If the start position is not valid,
     ...
     * found.
     * @throws SQLException If the pattern is null,
     ...
     * @throws SQLException If there is an error accessing the CLOB or if the position
     ...
     * @throws SQLException If there is an error accessing the CLOB value or if the position
     *                      specified is greater than the length of the CLOB.
     **/
     ...
     *                     truncation.
     * @throws SQLException If there is an error accessing the CLOB or if the length
     *                      specified is greater than the length of the CLOB.
     **/
