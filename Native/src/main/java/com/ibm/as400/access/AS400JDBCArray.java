...
public class AS400JDBCArray implements Array, Serializable {
    ...
    transient private java.sql.SQLData contentTemplate_;
    ...
    AS400JDBCArray(String typeName, Object[] data, int vrm,
        ...
        if (data instanceof java.sql.SQLData[]) {
            isSQLData_ = true;
            data_ = data;
        } else {
        ...
        for (int i = 0; isSQLData_ && (contentTemplate_ == null) && (i < data_.length); i++) {
            if (data_[i] != null) {
                contentTemplate_ = (java.sql.SQLData) data_[i];
            }
        }
     ...
     *
     * @return a constant from the class {@link Types} that is the type
     ...
     *              element is at index 1
     * @param count the number of successive SQL array elements to retrieve
     * @param map   the <code>Map</code> object that contains the mapping of SQL type
