...
extends ToolboxWrapper
     ...
     * @throws SQLException If the result set type is not valid.
     **/
        ...
        try {
            ...
            if (!isCatalogValid(catalog) ||     // catalog is empty string
                    ...
                    ((scope == bestRowSession) ||
                            ...
                            ((scope == bestRowTransaction) &&
                                    ((connection_.getAutoCommit() == true) ||
                                            (connection_.getTransactionIsolation() != Connection.TRANSACTION_REPEATABLE_READ))))) { // Return empty result set
                ...
                try {
                    ...
                    if (schema == null) {   // use default SQL schema or qgpl
                        request.setLibraryName(connection_.getDefaultSchema(), connection_.getConverter()); //@P0C
                    } else
                        request.setLibraryName(normalize(schema), connection_.getConverter());       // @E4C @P0C
        ...
        try {
            ...
            if ((!isCatalogValid(primaryCatalog)) ||     // primarycatalog is empty string
                ...
                try {
                    ...
                    if (primarySchema == null) {   // use default SQL schema or qgpl
                        request.setPrimaryKeyFileLibraryName(normalize(connection_.getDefaultSchema()), connection_.getConverter()); // @E4C @P0C
                    } else
                        request.setPrimaryKeyFileLibraryName(normalize(primarySchema), connection_.getConverter());              // @E4C @P0C

                    // Set the foreign key file library name
                    if (foreignSchema == null) {   // use default SQL schema or qgpl
                        request.setForeignKeyFileLibraryName(normalize(connection_.getDefaultSchema()), connection_.getConverter());    // @E4C @P0C
                    } else
                        request.setForeignKeyFileLibraryName(normalize(foreignSchema), connection_.getConverter());                  // @E4C @P0C
            ...
            if ((!isCatalogValid(catalog)) ||     // catalog is empty string
                ...
                try {
                    ...
                    if (schema == null) {   // use default SQL schema or qgpl
                        ...
                        request.setPrimaryKeyFileLibraryName(normalize(schema), connection_.getConverter());                         // @E4C @P0C
            ...
            if ((!isCatalogValid(catalog)) ||     // catalog is empty string
                ...
                try {
                    ...
                    if (schema == null) {   // use default SQL schema or qgpl
                        ...
                        request.setForeignKeyFileLibraryName(normalize(schema), connection_.getConverter()); // @E4C
            ...
            if ((!isCatalogValid(catalog)) ||     // catalog is empty string
                ...
                try {
                    ...
                    if (schema == null) {   // use default SQL schema or qgpl
                        ...
                        request.setLibraryName(normalize(schema), connection_.getConverter());                           // @E4C
            ...
            if ((!isCatalogValid(catalog)) ||     // catalog is empty string
                ...
                try {
                    ...
                    if (schema == null) {   // use default SQL schema or qgpl
                        ...
                        request.setPrimaryKeyFileLibraryName(normalize(schema), connection_.getConverter());                         // @E4C
            ...
            if (!isCatalogValid(catalog) ||     // catalog is empty string
                ...
                if (fileAttribute != -1) { // If -1, return empty set
                    ...
                    try {
                        ...
                        // If null, do not set parameter.  The system default value of
                        // *USRLIBL is used.
                        if (schemaPattern != null) { // use default SQL schema or qgpl
                            JDSearchPattern schema = new JDSearchPattern(schemaPattern);
                            request.setLibraryName(normalize(schema.getPatternString()), connection_.getConverter()); // @E4C
                            request.setLibraryNameSearchPatternIndicator(schema.getIndicator());
                        }
...
/* ifdef  JDBC40
        ...
        if (connection_.getVRM() >= JDUtilities.vrm440) {       // @B4D B5A @D0C
...
/* ifdef JDBC40
     ...
     * @throws SQLException If the result set type or result set
     ...
     * @throws SQLException If the transaction isolation level is not valid.
     **/
