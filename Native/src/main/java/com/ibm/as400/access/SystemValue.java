...
public class SystemValue implements Serializable {
    ...
    public SystemValue(AS400 system, String name) {
        super();
        if (Trace.traceOn_)
            Trace.log(Trace.DIAGNOSTIC, "Constructing SystemValue object, system: " + system + ", name: " + name);
        if (system == null) {
    ...
    SystemValue(AS400 system, SystemValueInfo info, Object value, String groupName, String groupDescription) {
        super();
        if (Trace.traceOn_)
            Trace.log(Trace.DIAGNOSTIC, "Constructing SystemValue object, system: " + system + ", group name: " + groupName);
        system_ = system;
        info_ = info;
        value_ = value;
     ...
     * @throws RequestNotSupportedException    If the IBM i release level of the system does not support the system value.
     * @see #getType
     **/
