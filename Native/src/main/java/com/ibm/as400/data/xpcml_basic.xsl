...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <xsl:text>
        ...
        <xpcml xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="4.0"
    ...
    <xsl:template
            match="stringParm[@name] | intParm[@name] | unsignedIntParm[@name] | hexBinaryParm[@name] | shortParm[@name] | unsignedShortParm[@name] | longParm[@name] | floatParm[@name] | doubleParm[@name] | zonedDecimalParm[@name] | packedDecimalParm[@name]">
