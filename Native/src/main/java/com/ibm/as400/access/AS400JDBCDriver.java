...
/* ifdef JAVA9
     ...
     * @throws SQLException If the driver is unable to make the connection.
     **/
    public Connection connect(AS400 system, boolean clone)
            throws SQLException {
        if (system == null)
            throw new NullPointerException("system");
     ...
     * @throws SQLException If the driver is unable to make the connection.
     **/
    public Connection connect(AS400 system, Properties info, String schema, boolean clone)
            throws SQLException {
        if (system == null)
            throw new NullPointerException("system");
     ...
     * @throws SQLException If the driver is unable to make the connection.
     **/
    public Connection connect(AS400 system, Properties info, String schema)
            throws SQLException {
        if (system == null)
            throw new NullPointerException("system");
