...
**/
    private void normalize(Object value, boolean open)
    {
        ...
        //@A1A
            ...
            setText (dateFormat_.format ((Date) value));
            setIcon (null);
        }

        //@A1A
        else if (value instanceof java.sql.Time) {
            setText (timeFormat_.format ((Date) value));
            setIcon (null);
        }

        // If its a date, then format it based on the locale.
        else if (value instanceof Date) { //@A1C
            setText (dateTimeFormat_.format ((Date) value)); //@A1C
            setIcon (null);
        }
