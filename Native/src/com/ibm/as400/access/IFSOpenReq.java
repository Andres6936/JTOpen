...
class IFSOpenReq extends IFSDataStreamReq {
     ...
     * @param duplicateFileOption  bit 4: on = fail the open if the file doesn't exist, replace the file if it does;
    ...
    IFSOpenReq(byte[] fileName,
        ...
        if (datastreamLevel < 16) { // Just set the old fields (4-byte length).
