        ...
        {                                                                   //@pase1
            try {                                                            //@pase1
                ...
                {                                                               //@pase1
                    //load 64 bit version
                    if (Trace.traceOn_)
                        Trace.log(Trace.DIAGNOSTIC, "Loading Native PASE methods for 64bit libs if available");//@pase1
                ...
                {                                                               //@pase1
                    //load 32 bit version
                    if (Trace.traceOn_)
                        Trace.log(Trace.DIAGNOSTIC, "Loading Native PASE methods for 32bit libs if available");//@pase1
